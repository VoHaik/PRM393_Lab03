...
class _DetailScreenState extends State<DetailScreen> {
  ...
  void initState() {
    super.initState();
    // Log the view publication event to Firebase Analytics
    di.sl<AnalyticsService>().logViewPublication(
      title: widget.publication.title,
      year: widget.publication.publicationYear,
    );
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                    ...
                    Row(
                      ...
                      children: [
                        Container(
                          ...
                          child: Text(
                            widget.publication.publicationYear.toString(),
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              '${widget.publication.citedByCount} Citations',
                              style: const TextStyle(
              ...
              const SizedBox(height: 8),
              if (widget.publication.authors.isNotEmpty)
                Container(
                  padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12),
                  decoration: AppTheme.glassBox(),
                  child: Column(
                    children: widget.publication.authors.map((author) {
                      return Padding(
              ...
              Container(
                ...
                child: Text(
                  widget.publication.abstractText,
                  style: const TextStyle(
                    fontSize: 14,
                    height: 1.5,
                    color: AppTheme.textPrimary,
              ...
              // DOI Link launcher
              if (widget.publication.doiUrl.isNotEmpty)
                Center(
                  child: SizedBox(
                    width: double.infinity,
                    child: ElevatedButton.icon(
                      onPressed: () => _launchDoi(widget.publication.doiUrl),
